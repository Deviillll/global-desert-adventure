...
const SafetyInfo: React.FC<BuggyToursProps> = ({
  ...
  return (
    <div
      className="h-[140vh] container py-5  bg-no-repeat  bg-cover bg-center relative lg:bg-[length:170%] text-white flex flex-col lg:items-start items-center justify-center lg:justify-around "
      style={{
        backgroundImage:
    ...
    >
        <h1 className="text-5xl font-semibold relative z-30 text-center w-full mb-4 md:mb-0 mt-4">SAFETY INFO CAMP</h1>
      ...
      <Card className={`glass backdrop-blur-xs w-[90%] h-[full]  lg:w-[570px] lg:h-[100vh] relative z-20   px-5  lg:left-[10%]   rounded-3xl`}>
        <CardContent className="">
            ...
            <CardDescription className="py-3 text-white">
                ...
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus, repellat perferendis iste doloribus quo libero error dolor vel sit itaque repudiandae veritatis laboriosam explicabo odit ipsum recusandae corporis facere enim nam illo deserunt saepe maxime. Possimus nulla 
            </CardDescription>
               </div>
              ))
